...
export const buttonVariants = cva(
  'active:scale-95 inline-flex items-center justify-center rounded-2xl font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:drop-shadow-lg disabled:opacity-50 disabled:pointer-events-none mr-4',
  {
    variants: {
      variant: {
        primary:
